package com.example.lesson039_onupgrade_renewsqlite;
...
//    final int DB_VERSION = 1; // версия БД
    final int DB_VERSION = 2;//обновляем версию БД
    ...
    private void writeStaff(SQLiteDatabase db) {
        //после изменения номера БД для обновления
        Cursor c = db.rawQuery("select * from people", null);
        logCursor(c, "Table people");
        c.close();
        //изменения DB_VERSION = 2---------------------------------
